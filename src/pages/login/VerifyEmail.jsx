...
function VerifyEmail() {
  ...
  return (
    <div className="flex flex-col items-center p-6">
      <span className="text-2xl font-medium mt-52">Forgot password</span>
      <span className="mt-6 text-textSubdued text-center">
        Enter the OTP sent to your email (can be found in the spam folder)
      </span>
      ...
      <div className="flex flex-row mt-6">
        {arrOtp.map((valueOtp, key) => (
          <input
            ...
            value={valueOtp}
            onChange={(newValue) => {
              const formatValue = newValue.target.value.replace(/[^0-9]+/g, "");
      ...
      <Button
        className={"mt-12"}
        disable={arrOtp.findIndex((e) => e === "") === -1 ? false : true}
      >
        Verify
      </Button>
      <Img
